...
<template>
  <div class="melon-upload">
    <div class="melon-upload__content" @click="handleClick">
      <slot>
        <melon-button type="primary">Upload File</melon-button>
      </slot>
    </div>
    <input
      ref="fileInputRef"
      class="melon-file-input"
      type="file"
