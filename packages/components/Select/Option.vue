er<script setup lang="ts">
import type { SelectOptionProps } from "./types";
import { computed, inject } from "vue";
import { SELECT_CTX_KEY } from "./constants";
import { every, eq, get } from "lodash-es";
import { RenderVnode } from "@melon-element/utils";
defineOptions({ name: "MelonOption" });
